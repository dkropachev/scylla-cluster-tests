...
class GkeScyllaPodContainer(BaseScyllaPodContainer, IptablesPodIpRedirectMixin):
    ...
    def terminate_k8s_node(self):
        ...
        # There is a bug in GCE, it keeps instance up when it is deleted via kubectl
        # TBD: Remove below line when https://issuetracker.google.com/issues/178302655 is fixed
